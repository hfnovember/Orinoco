...
<?php if (!isset($_SESSION["UserID"])) header("Location: login.php?status=noLogin"); ?>
    ...
    <header>
        ...
        <ul class="side-nav" id="mobile-demo">
            ...
            echo'<li><a href="wishlist.php"><i class="material-icons left">star</i>Wishlist</a></li>
            <li><a href="purchases.php"><i class="material-icons left">shop_two</i>Purchases</a></li>
			<li><a href="account.php"><i class="material-icons left">person_pin</i>Account</a></li>
            <li><a href="php/performLogout.php"><i class="material-icons left">power_settings_new</i>Log Out</a></li>
            '; ?>
    ...
    <main>
        <div class="container" style="margin-top: 30px;">
        	...
        	<h4><?php echo $_SESSION["UserFirstName"]; ?>'s Wishlist</h2>
            ...
            <?php
				...
				if (isset($_GET["status"])) {
					...
					if ($_GET["status"] == "itemMoved") {
						echo '<p class="green white-text center">Item moved to Shopping Cart.</p>';
					}//end itemDeleted
					else if ($_GET["status"] == "failedToMove") {
						echo '<p class="red white-text center">Failed to move item to shopping cart.</p>';
					}//end failedToDelete
        	...
        	<div class="row">
        		<?php include("php/showWishlist.php"); ?>
            </div>
