...
<body>
    ...
    <main>
        <div class="container" style="margin-top: 30px;">
            ...
            <h5 class="collection-header">All Purchases</h5>
            
            <p>The following is a list of purchases for each user.</p>
            ...
            <?php
				...
				$sqlGetUsers = "SELECT * FROM users WHERE IsAdmin = 0";
				$sqlGetUsersR = mysql_query($sqlGetUsers) or die(mysql_error());
				
				echo '<ul class="collapsible" data-collapsible="accordion">';
				
				while ($rowUser = mysql_fetch_array($sqlGetUsersR, MYSQL_ASSOC)) {
					echo '<li>';
					echo '<div class="collapsible-header blue-grey darken-1 white-text">' . $rowUser["Username"] . '</div>';
					echo '<div class="collapsible-body">';
					
					
					$sqlGetPurchases = "SELECT * FROM purchases WHERE PurchaseUserID=" . $rowUser["UserID"];
					...
					while ($rowPurchase = mysql_fetch_array($sqlGetPurchasesR, MYSQL_ASSOC)) {
						...
						echo'<span class="card-title">Order at ' . $rowPurchase["PurchaseDateTime"] . '</span>';
